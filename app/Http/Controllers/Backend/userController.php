...
class userController extends Controller
{
    ...
    public function create()
    {
        ...
        $mitrakerjasama=Mitrakerjasama::pluck('nama', 'id');
        return view('backend.user.tambah', compact('aksesgrup','mitrakerjasama'));
    }
    ...
    public function edit($id)
    {
        ...
        $aksesgrup=Aksesgrup::byLevel()->pluck('nama', 'id');
        $mitrakerjasama=Mitrakerjasama::pluck('nama', 'id');
        return view('backend.user.ubah', compact('user', 'aksesgrup','mitrakerjasama'));
    }
