...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="form-group">
            {!! Form::label('mitrakerjasama', 'Pilih Instansi', array('class' => 'control-label')) !!}
            {!! Form::select('mitrakerjasama_id', $mitrakerjasama, null, array('id' => 'mitrakerjasama_id', 'class' => 'form-control')) !!}
        </div>
    </div>
</div>
<div class="row">
