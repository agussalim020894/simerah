...
<div class="row">
    ...
    <div class="form-group col-md-6">
        {!! Form::label('mitrakerjasama', 'Pilih Instansi', array('class' => 'col-md-6 control-label')) !!}
        {!! Form::select('mitrakerjasama_id', $mitrakerjasama, $user->mitrakerjasama->id??null, array('id' => 'mitrakerjasama_id', 'class' =>
        'form-control')) !!}
    </div>
